...
def read_url():
    ...
    return render_template("/html/dashboard.html", title = title, selected_image_url = url_for('static', filename='images/pie_chart.png'))
...
def select():
    ...
    return render_template('/html/dashboard.html', selected_image_url=selected_image_url)
